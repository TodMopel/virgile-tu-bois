...
function WarmGlow({ energyRef }: Pick<VisualProps, "energyRef">) {
...
export function V05ElectroSoul({ energyRef }: VisualProps) {
  return (
    <Stage
      background="linear-gradient(135deg, #260800, #6e2308 55%, #a83f10)"
      energyRef={energyRef}
      flashBand="mid"
      flashColor="255,180,110"
    >
      <WarmGlow energyRef={energyRef} />
      <TitleText
        energyRef={energyRef}
